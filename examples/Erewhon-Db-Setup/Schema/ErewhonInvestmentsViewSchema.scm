...
localeDefinitions
	...
	10249 "English (Belize)" _cloneOf 5129;
		setModifiedTimeStamp "<unknown>" "" 2020:11:20:10:55:48;
...
starts, therefore they cannot be debugged.`
	...
	jadeMethodDefinitions
		getAgent(name: String): Agent number = 1004;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:11:00:31.504;
		getAllAgents(): AgentByNameDict number = 1006;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:11:16:02.990;
		getAllClients(): ClientByNameDict number = 1013;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:11:27:50.086;
		getAllSales(): SaleByItemDict number = 1001;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:11:27:54.267;
		getClient(name: String): Client number = 1002;
		...
		getSaleItemsByPrice(
			minPrice: Integer; 
			maxPrice: Integer): SaleItemByCodeDict number = 1009;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:11:30:49.026;
		postAgent(address: Address) number = 1007;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:09:46:09.566;
		postClient(address: Address) number = 1008;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:09:41:07.274;
		postRetailSale(
			clientName: String; 
			codePrefix: String; 
			codeNumber: Integer; 
			offer: Decimal) number = 1012;
		setModifiedTimeStamp "cnwta3" "20.0.01" 2020:11:24:10:42:44.832;
		postTender(
			clientName: String; 
			codePrefix: String; 
			codeNumber: Integer; 
			offer: Decimal) number = 1011;
...
begin
	return app.myCompany.allAgents.cloneSelf(true);
end;
...
begin
	return app.myCompany.allClients.cloneSelf(true);
end;
...
getAllSales
{
getAllSales() : SaleByItemDict;

vars

begin
	return app.myCompany.allSalesByItem.cloneSelf(true);
end;
